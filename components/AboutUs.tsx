...
export default function AboutUs() {
  ...
  const milestones = t('aboutUs.timeline.milestones', { returnObjects: true }) as Array<{
    year: string;
    title: string;
    description: string;
  }>;

  const coreValuesData = t('aboutUs.coreValues.values', { returnObjects: true }) as Array<{
    title: string;
    description: string;
  }>;
              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleReviewSubmit} className="space-y-6 max-w-2xl mx-auto">
                  ...
                  <RippleButton
                    type="submit"
                    disabled={submitting}
                    className={`w-full bg-gradient-to-r from-[#FFDD00] to-[#FFE640] text-black font-bold py-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[#FFDD00]/30 uppercase tracking-wide text-sm ${
